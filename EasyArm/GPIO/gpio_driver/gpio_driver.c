...
static struct gpio_info all_gpios_info_287B[] ={
        ...
        {PINID_AUART3_RX,    "gpio-URX3",       NULL},
        {PINID_AUART3_TX,    "gpio-UTX3",       NULL},
        {PINID_AUART2_RX,    "gpio-URX2",       NULL},
        {PINID_AUART2_TX,    "gpio-UTX2",       NULL},
        ...
        /* J2 in imx287  */
        {PINID_SSP2_MISO,   "gpio-P2.18",       NULL},
        {PINID_SSP2_SS0,    "gpio-P2.19",       NULL},
        {PINID_SSP2_SCK,    "gpio-P2.16",       NULL},
        {PINID_SSP2_MOSI,   "gpio-P2.17",       NULL},
        {PINID_SSP1_DATA0,  "gpio-P2.14",       NULL},
        {PINID_SSP1_DATA3,  "gpio-P2.15",       NULL},
        {PINID_AUART1_RTS,  "gpio-P3.7",        NULL},
        {PINID_AUART1_CTS,  "gpio-P3.6",        NULL},
        {PINID_LCD_DOTCK,   "gpio-P1.30",       NULL},
        {PINID_LCD_ENABLE,  "gpio-P1.31",       NULL},
        {PINID_LCD_VSYNC,   "gpio-P1.28",       NULL},
        {PINID_LCD_HSYNC,   "gpio-P1.29",       NULL},
...
static struct gpio_info all_gpios_info_280[] ={
   	{PINID_AUART0_CTS,   "gpio-DRX",        NULL},
        {PINID_AUART0_RTS,   "gpio-DTX",        NULL},
        {PINID_AUART0_RX,    "gpio-RX0",        NULL},
        {PINID_AUART0_TX,    "gpio-TX0",        NULL},
        {PINID_AUART1_RX,    "gpio-RX1",        NULL},
        {PINID_AUART1_TX,    "gpio-TX1",        NULL},
        {PINID_SSP2_SCK,     "gpio-RX2",        NULL},
        {PINID_SSP2_MOSI,    "gpio-TX2",        NULL},
        {PINID_SSP2_MISO,    "gpio-RX3",        NULL},
        {PINID_SSP2_SS0,     "gpio-TX3",        NULL},
        {PINID_SAIF0_BITCLK, "gpio-RX4",        NULL},
        {PINID_SAIF0_SDATA0, "gpio-TX4",        NULL},
        {PINID_GPMI_RDY3,    "gpio-CR0",        NULL},
        {PINID_GPMI_RDY2,    "gpio-CT0",        NULL},
        {PINID_GPMI_CE3N,    "gpio-CR1",        NULL},
        {PINID_GPMI_CE2N,    "gpio-CT1",        NULL},
        {PINID_SSP0_DATA7,   "gpio-RUN",        NULL},
        {PINID_SAIF0_MCLK,   "gpio-ERR",        NULL},
        {PINID_SSP3_MISO,    "gpio-MISO",       NULL},
        {PINID_SSP3_MOSI,    "gpio-MOSI",       NULL},
        {PINID_SSP3_SCK,     "gpio-SCK",        NULL},
        {PINID_SSP3_SS0,     "gpio-SS0",        NULL},
        {PINID_SAIF1_SDATA0, "gpio-PWM7",       NULL},
        {PINID_SAIF0_LRCLK,  "gpio-PWM4",       NULL},
        {PINID_PWM3,         "gpio-PWM3",       NULL},
        {PINID_LCD_WR_RWN,   "gpio-P1.25",      NULL},
        {PINID_LCD_RD_E,     "gpio-P1.24",      NULL},
        {PINID_LCD_D07,      "gpio-P1.7",       NULL},
        {PINID_AUART3_RX,    "gpio-R3",         NULL},
        {PINID_AUART3_TX ,   "gpio-T3",         NULL},
        {PINID_AUART2_RX,    "gpio-R2",         NULL},
        {PINID_AUART2_TX,    "gpio-T2",         NULL},
        {PINID_PWM1,         "gpio-SDA1",       NULL},
        {PINID_PWM0,         "gpio-SCL1",       NULL},
        {PINID_I2C0_SDA,     "gpio-SDA0",       NULL},
        {PINID_I2C0_SCL,     "gpio-SCL0",       NULL},
